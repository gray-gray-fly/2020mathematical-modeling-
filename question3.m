...
[num txt raw]=xlsread('附件4-问题3数据','飞行器理想质心');
...
restfuel=zeros(7200,6);
  ...
  restfuel(1,1:6)=[240 1560 1920 1800 1600 300];   %initial data
%  restfuel(1,1:6)=[300 1600 1970 2030 2000 660]; 
...
r=sqrt(cx.^2+cy.^2+cz.^2);cr=r(:,1);
figure;
plot(t(2:end),cr(2:end),'LineWidth',5)
hold on
